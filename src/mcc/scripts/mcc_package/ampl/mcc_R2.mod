...
maximize Value:
  sum {q1 in CONTROLLER_NODES, q2 in CONTROLLER_NODES, s1 in STATES, s2 in STATES} q0[q1, q2] * b0[s1, s2] * V2[q1, q2, s1, s2];
...
subject to Probability_Constraint_Eta2_Normalization {q in CONTROLLER_NODES, a in ACTIONS, o in OBSERVATIONS}:
  sum {qp in CONTROLLER_NODES} eta2[q, a, o, qp] = 1.0;

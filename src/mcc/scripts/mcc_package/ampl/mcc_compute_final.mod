...
param R0 {s1 in STATES, s2 in STATES, a1 in ACTIONS, a2 in ACTIONS} default 0.0;
param R1 {s1 in STATES, s2 in STATES, a1 in ACTIONS, a2 in ACTIONS} default 0.0;
param R2 {s1 in STATES, s2 in STATES, a1 in ACTIONS, a2 in ACTIONS} default 0.0;
...
maximize Value:
  sum {q1 in CONTROLLER_NODES, q2 in CONTROLLER_NODES, s1 in STATES, s2 in STATES} q0[q1, q2] * b0[s1, s2] * V0[q1, q2, s1, s2];
...
subject to Bellman_Constraint_V1 {q1 in CONTROLLER_NODES, q2 in CONTROLLER_NODES, s1 in STATES, s2 in STATES}:
  V1[q1, q2, s1, s2] = sum {a1 in ACTIONS, a2 in ACTIONS} ( psi1[q1, a1] * psi2[q2, a2] * ( R1[s1, s2, a1, a2] + gamma * sum {sp1 in STATES, sp2 in STATES} ( T[s1, s2, a1, a2, sp1, sp2] * sum {o1 in OBSERVATIONS, o2 in OBSERVATIONS} ( O[a1, a2, sp1, sp2, o1, o2] * sum {qp1 in CONTROLLER_NODES, qp2 in CONTROLLER_NODES} ( eta1[q1, a1, o1, qp1] * eta2[q2, a2, o2, qp2] * V1[qp1, qp2, sp1, sp2] ) ) ) ) );

subject to Bellman_Constraint_V2 {q1 in CONTROLLER_NODES, q2 in CONTROLLER_NODES, s1 in STATES, s2 in STATES}:
  V2[q1, q2, s1, s2] = sum {a1 in ACTIONS, a2 in ACTIONS} ( psi1[q1, a1] * psi2[q2, a2] * ( R2[s1, s2, a1, a2] + gamma * sum {sp1 in STATES, sp2 in STATES} ( T[s1, s2, a1, a2, sp1, sp2] * sum {o1 in OBSERVATIONS, o2 in OBSERVATIONS} ( O[a1, a2, sp1, sp2, o1, o2] * sum {qp1 in CONTROLLER_NODES, qp2 in CONTROLLER_NODES} ( eta1[q1, a1, o1, qp1] * eta2[q2, a2, o2, qp2] * V2[qp1, qp2, sp1, sp2] ) ) ) ) );
